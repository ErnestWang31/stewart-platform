# Quick analysis of trajectory update data
import csv
import numpy as np

filename = "results/experiment_trajectory_update_20251125_164933.csv"
...
if np.any(near_zero):
    print(f"  First time near center: t={time_data[near_zero][0]:.2f}s")
    print(f"  Setpoint at that time: {setpoint_data[near_zero][0]*100:.2f}cm")
